    ...
    <div className="">
      {contacts.length === 0 ? (
        <p className="text-center mt-4">
          No contacts found. Please create a contact using the add contact
          button.
        </p>
      ) : (
        <div className="grid md:grid-cols-3 gap-8 md:gap-12">
          {contacts.map((contact: Contact) => (
            <div
              key={contact.id}
              className="relative bg-white border border-gray-200 rounded-lg shadow md:max-w-xl hover:bg-gray-100 dark:border-gray-700 hover:cursor-pointer"
            >
